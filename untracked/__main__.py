...
def main():
  ...
  parser.add_argument('--exclude', dest='exclude', action='append', default=['*.pyc', '.*'], help='Exclude files. Default: *.pyc., .*')
  parser.add_argument('--excludedir', dest='excludedir', action='append', default=['.git',], help='Exclude directories. Default: .git')
